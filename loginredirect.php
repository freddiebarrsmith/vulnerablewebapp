...
document.cookie = "JamesTargetfca3ffea6534176432f58b5a22ed22e1";
}
writecookie();
</script>
                    ...
                    <div class="inner cover">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <p class="text-left"></p>
                                <form action="transferredirect.php" method="post">
                                    <font size="5" color="black"><input id="name" name="name" autofocus=""><br>
                                    <p class="lead"></p>
