                    ...
                    <div class="inner cover">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <p class="text-left"></p>
                                <form action="transfercookie.php" method="post">
                                    <font size="5" color="black"><label for="inputEmail" class="sr-only">Username</label> <input id="name" name="name" class="form-control" placeholder="Username" required="" autofocus=""><br>
...
<br>
                               <button type="submit" value=" Send" class="btn btn-lg btn-default" id="submit" onclick= "writecookie()"><font size="5" color="black">Login</font></button></font>
                                </form>
